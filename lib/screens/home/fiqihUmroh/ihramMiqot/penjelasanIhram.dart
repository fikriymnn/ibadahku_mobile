...
class PenjelasanIhram extends StatefulWidget {
  const PenjelasanIhram({super.key});

  @override
  State<PenjelasanIhram> createState() => _PenjelasanIhramState();
}

class _PenjelasanIhramState extends State<PenjelasanIhram> {
  double sizeTitle = 18;
  double sizeText = 14;
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                      fontWeight: FontWeight.bold, fontSize: sizeArabic),
                ),
                SizedBox(
                  height: 10,
                ),
