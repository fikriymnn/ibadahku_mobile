...
class DoaKuburSyuhadauhudScreen extends StatefulWidget {
  const DoaKuburSyuhadauhudScreen({super.key});

  @override
  State<DoaKuburSyuhadauhudScreen> createState() =>
      _DoaKuburSyuhadauhudScreenState();
}

class _DoaKuburSyuhadauhudScreenState extends State<DoaKuburSyuhadauhudScreen> {
  ...
  List keutamaanHaji = [
    {
      "no": "0",
      "title": "",
      "penjelasan": "Doa saat ziarah ke Kuburan Syuhada uhud adalah: ",
      "ayat":
      ...
      "arti":
          "Salam sejahtera atasmu wahai para syuhada Uhud. Ya Allah, berilah mereka pahala karena Islam dan para pemeluknya dengan pahala yang paling utama dan tinggikanlah derajat mereka don muliakan kedudukan mereka dengan keagungan-Mu dan kemurahan-Mu, wahai Tuhan Yang Maha Pemurah",
      "img": ""
    },
  ];
}
