...
class PenjelasanKuburBaqiScreen extends StatefulWidget {
  const PenjelasanKuburBaqiScreen({super.key});

  @override
  State<PenjelasanKuburBaqiScreen> createState() =>
      _PenjelasanKuburBaqiScreenState();
}

class _PenjelasanKuburBaqiScreenState extends State<PenjelasanKuburBaqiScreen> {
